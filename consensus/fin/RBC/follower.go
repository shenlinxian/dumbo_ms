...
func NewBroadcast_follower(nid int, lid int, sid int, num int, output chan pb.RBCOut, msgIn chan pb.RBCMsg, msgOut chan pb.RBCMsg, height int, done chan bool) BC_f {
