...
func NewBroadcast_leader(nid int, lid int, round int, num int, input []byte, output1 chan pb.RBCOut, output2 chan pb.RBCOut, msgIn chan pb.RBCMsg, msgOut chan pb.RBCMsg, close chan bool) BC_l {
	newBC_l := BC_l{
		nid:       nid,
		lid:       lid,
		num:       num,
