...
def reliablebroadcast(sid, pid, N, f, leader, input, receive, send):
    ...
    def broadcast(o):
        #with open(filename, 'a', encoding='utf-8') as file:
        #    file.write('inside consensus reliablebroadcast broadcast message' + "\n")
        for i in range(N):
            send(i, o)

    if pid == leader:
        #with open(filename, 'a', encoding='utf-8') as file:
        #    file.write('inside consensus mine reliablebroadcast' + "\n")
        ...
        for i in range(N):
            ...
            #with open(filename, 'a', encoding='utf-8') as file:
            #    file.write('inside consensus mine reliablebroadcast sending val' + "\n")
