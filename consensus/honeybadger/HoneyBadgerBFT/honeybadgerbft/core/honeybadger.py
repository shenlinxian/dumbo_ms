...
from honeybadgerbft.core.commoncoin import fake_coin
...
from honeybadgerbft.core.honeybadger_block import honeybadger_block_without_encryption
...
#    def __init__(self, sid, pid, B, N, f, sPK, sSK, ePK, eSK, send, recv, k):
    def __init__(self, sid, pid, N, f,send, recv, k):
        self.sid = sid
        self.pid = pid
        #self.B = B
        self.N = N
        ...
        self.round = k  # Current block number
    ...
    def _run_round(self, r, tx_to_send, send, recv):
        ...
        #filename="/home/luy/golang_projects/src/dumbo_ms/log/data%d.json" % (self.pid)
        #with open(filename, 'a', encoding='utf-8') as file:
        #    file.write('inside consensus run round' + "\n")
        ...
        def _setup(j):
            ...
            #filename="/home/luy/golang_projects/src/dumbo_ms/log/data%d.json" % (self.pid)
            #with open(filename, 'a', encoding='utf-8') as file:
            #    file.write('inside consensus init aba' + "\n")
            ...
            #with open(filename, 'a', encoding='utf-8') as file:
            #    file.write('inside consensus after init aba' + "\n")
            def rbc_send(k, o):
        ...
        return honeybadger_block_without_encryption(self.pid,self.N, self.f,_input.get,
