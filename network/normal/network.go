...
func (pn *NormalNetwork) SendMsgRouter() {
	for {
...
func (pn *NormalNetwork) HandlePriorities() {
...
func (pn *NormalNetwork) HandleConn() {
...
func (pn *NormalNetwork) InitSendBuf() {
...
func (pn *NormalNetwork) InitRcvBuf() {
...
func (pn *NormalNetwork) Receive(priority int, consInMsgCH chan pb.ConsInMsg) {
	for i := 0; i < pn.N; i++ {
...
func (pn *NormalNetwork) HandleOwnCallHelp() {
