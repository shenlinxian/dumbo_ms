...
type NormalNetworkLimit struct {
	ID            int
	N             int
	Fault         int
	Height        int
...
func (pn *NormalNetworkLimit) ReadIPs() {
...
func (pn *NormalNetworkLimit) SendMsgRouter() {
	for {
...
func (pn *NormalNetworkLimit) HandlePriorities() {
...
func (pn *NormalNetworkLimit) HandleConn() {
...
func (pn *NormalNetworkLimit) InitSendBuf() {
...
func (pn *NormalNetworkLimit) InitRcvBuf() {
...
func (pn *NormalNetworkLimit) Receive(priority int, consInMsgCH chan pb.ConsInMsg) {
	for i := 0; i < pn.N; i++ {
...
func (pn *NormalNetworkLimit) HandleOwnCallHelp() {
